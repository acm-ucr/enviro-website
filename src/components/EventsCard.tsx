...
const EventCard = ({
  ...
  return (
    <div className="font-enviro-open-sans text-enviro-green-400 flex w-7/12 rounded-tl-2xl rounded-bl-2xl shadow-md shadow-gray-500">
      ...
      <div className="bg-enviro-gray-100 border-enviro-green-300 relative flex flex-col gap-y-2 border-t-1 border-r-1">
        <div className="bg-enviro-green-300 text-enviro-green-100 mt-3 ml-3 w-fit rounded-3xl px-5 text-2xl">
          {eventName}
        </div>
