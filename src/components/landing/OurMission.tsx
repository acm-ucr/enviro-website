      ...
      <div className="z-10 col-start-1 row-start-1 flex flex-col items-center justify-around md:absolute md:mt-[5%] md:mb-[10%] md:flex-row">
        ...
        <div className="flex h-8/12 w-full flex-col items-center gap-2 text-center text-white md:w-4/10">
          <motion.div
            ...
            whileInView="whileInView"
            viewport={{ once: true }}
            className="font-enviro-single-day mt-2 text-3xl sm:text-4xl md:mt-0 md:text-4xl md:whitespace-nowrap lg:text-5xl xl:text-6xl 2xl:text-7xl"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="text-md w-10/12 pb-5 sm:pb-2 sm:text-lg md:w-full lg:text-2xl xl:text-3xl 2xl:text-4xl"
          >
