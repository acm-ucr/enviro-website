    ...
    <div className="relative grid">
      ...
      <div className="z-10 col-start-1 row-start-1 flex flex-col items-center justify-around md:absolute md:mt-[5%] md:mb-[10%] md:flex-row">
        ...
        <div className="flex h-8/12 w-full flex-col items-center gap-2 text-center text-white md:w-4/10">
          ...
          />
          <div className="text-md w-10/12 pb-5 sm:pb-2 sm:text-lg md:w-full lg:text-xl xl:text-2xl 2xl:text-3xl">
      ...
      <Image
        src={Flower}
        alt="Green Flower"
        className="absolute right-[46%] bottom-[3vh] z-20 scale-35 sm:bottom-[25vh] sm:-left-[25%] sm:scale-45 md:-bottom-[4vh] md:-left-[20%] lg:bottom-[5vh] lg:-left-[13vw] lg:scale-70 xl:bottom-[12vh] xl:scale-90 2xl:top-[65vh] 2xl:-left-[10vw] 2xl:scale-100"
      />
    </div>
  );
};
